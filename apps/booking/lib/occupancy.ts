/**
 * @duplicated apps/readonly/lib/occupancy.ts
 * TODO: mover a packages/utils cuando se cree el package compartido.
 *       Requiere: turbo.json, pnpm-workspace.yaml, tsconfig de booking y readonly.
 * @see https://linear.app/gusm/... ← linkear el issue cuando lo crees
 *
