...
export type Database = {
  ...
  private: {
    Tables: {
      check_in_qr_token: {
        Row: {
          ...
          scan_result: Database["private"]["Enums"]["check_in_qr_scan_result"] | null;
    ...
    Enums: {
      check_in_qr_scan_result: "checked_in" | "already_present" | "no_current_booking";
  ...
  public: {
    ...
    Enums: {
      ...
      booking_admission_source: "self_service" | "staff_exception" | "staff_overcapacity";
      booking_event_type:
        | "reserved"
        | "reactivated"
        | "cancelled"
